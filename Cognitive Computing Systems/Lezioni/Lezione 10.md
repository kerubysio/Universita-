...
E poi nel materiale condiviso ci sta una cartella verde "INTRO TO PHYTON FOR COMPUTER SCIENCE AND DATA SCIENCE", la apri e vai su "Deitel Python slides", poi "Slides" fino a trovare dei file che si chiamano "ch".
Per visualizzare i capitoli devi (credo) scaricare tutta quanta la cartella e aprirla in anaconda.
